...
public class Board extends JPanel implements ActionListener {
    ...
    private void loadImages() {
        ...
        ImageIcon iid = new ImageIcon("src/main/java/folder/dot.png");
        ball = iid.getImage();

        ImageIcon iia = new ImageIcon("src/main/java/folder/apple.png");
        apple = iia.getImage();

        ImageIcon iih = new ImageIcon("src/main/java/folder/head.png");
        head = iih.getImage();
    }
